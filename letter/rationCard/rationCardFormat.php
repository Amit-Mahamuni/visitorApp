...
<body>
    ...
    <form id="ration_letter_frm">
        <div class="container my-4">
            <div class="row">
                <div class="col-md-6">
                    <h6>Ration Card Letter Format</h6>
                </div>
                <div class="col-md-6">
        ...
        <div class="container border border-dark my-5 p-5">
            ...
            <br>
                ...
                <div class="row">
                    <div class="col-12 px-1">
                        <div class="d-flex justify-content-between">
                            ...
                            <textarea name="rationcardL_to" id="rationcardL_to" cols="30" rows="5"></textarea>                    
                        </div>                 
                    </div>
                </div>          
                ...
                <div class="row my-4">
                    <div class="col-12">
                        <div class="d-flex justify-content-center">
                            <textarea name="rationcardL_subject" id="rationcardL_subject" cols="100%" rows="1"></textarea>                    
                        </div> 
                    </div>
                </div>
                ...
                <div class="row my-2">            
                    <div class="col-12">
                        <div class="d-flex justify-content-center">
                            <textarea name="rationcardL_detail" id="rationcardL_detail" cols="210" rows="10"></textarea>
                        </div>                
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 py-3">
                        <div class="d-flex justify-content-end">
                            <textarea name="rationcardL_sign" id="rationcardL_sign" cols="30" rows="5"></textarea>                    
                        </div>                 
                    </div>
                </div>             
        </div>
    ...
    <script src="rationCardFormat.js"></script>
