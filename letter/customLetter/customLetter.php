...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4 py-2">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">   
                            <input type="text" class="form-control form-control-sm" id="work_status" name="work_status" placeholder="Work Status" disabled> 
                    ...
                    <div class="form-group">                         
                        ...
                        <small id="work_title" class="form-text text-muted">Title</small>
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group col-md-6">  
                            <input type="text" class="form-control form-control-sm" id="work_category" name="work_category" placeholder="Work Category" disabled>
                    ...
                    <div class="form-group">                   
                        <textarea class="form-control form-control-sm" name="work_detail" id="work_detail" rows="2" cols="100%" placeholder="Work Note" disabled></textarea>
                ...
                <div class="p-4" style="background-color:lightblue">
                    ...
                    <div class="container my-5 p-5 print-conatiner" style="background-color:white">
                        <div class="row">
                            <div class="col-12 px-1">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <!-- <input type="hidden" id="visitor_id_frm" name="visitor_id"> -->
                        ...
                        <div class="row my-4">
                            <div class="col-12 py-3">
                                <div class="d-flex justify-content-center">
                                    <textarea class="textarea_l text-center" name="letter_title" id="letter_title" cols="30" rows="2"></textarea>                    
                                </div>                 
                            </div>
                        </div>          
                        <br>
                        ...
                        <div class="row my-4">
                            <div class="col-12">
                                <div class="d-flex justify-content-center">
                                    <textarea class="textarea_l" name="letter_subject" id="letter_subject" cols="100%" rows="1"></textarea>                    
                                </div> 
                            </div>
                        </div>
                        ...
                        <div class="row my-2">            
                            <div class="col-12">
                                <div class="d-flex justify-content-center">
                                    <textarea class="textarea_l" name="letter_detail" id="letter_detail" cols="210" rows="10"></textarea>
                                </div>                
                            </div>
                        </div>
    ...
    <script src="customLetter.js"></script> 
