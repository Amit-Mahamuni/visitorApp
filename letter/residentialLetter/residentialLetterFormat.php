...
<head>
    ...
    <title>Residential Letter Format</title>
...
<body>
    ...
    <form id="residential_letter_frm">
        <div class="container my-4">
            <div class="row">
                <div class="col-md-6">
                    <h6>Residential Letter Format</h6>
                </div>
                <div class="col-md-6">
                    <div class=" d-flex justify-content-end">
                        <button type="submit" id="updateRL" class="btn btn-primary btn-sm mr-4"  id="save_letter">Save</button>
        ...
        <div class="container border border-dark my-5 p-5" >
            ...
            <br>
                ...
                <div class="row my-4">
                    <div class="col-12 px-1">
                        <div class="d-flex justify-content-center">
                            ...
                            <textarea name="residentialL_to" id="residentialL_to" cols="30" rows="1"></textarea>                    
                        </div>                 
                    </div>
                </div>          
                <br><br><br>
                <div class="row my-4">
                    <div class="col-12">
                        <div class="d-flex justify-content-center">
                            <textarea name="residentialL_subject" id="residentialL_subject" cols="100%" rows="1"></textarea>                    
                        </div> 
                    </div>
                </div>
                ...
                <div class="row my-2">            
                    <div class="col-12">
                        <div class="d-flex justify-content-center">
                            <textarea name="residentialL_detail" id="residentialL_detail" cols="210" rows="10"></textarea>
                        </div>                
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 py-3">
                        <div class="d-flex justify-content-end">
                            <textarea name="residentialL_sign" id="residentialL_sign" cols="30" rows="5"></textarea>                    
                        </div>                 
                    </div>
                </div>             
        </div>
    ...
    <script src="residentialLetterFormat.js"></script>
