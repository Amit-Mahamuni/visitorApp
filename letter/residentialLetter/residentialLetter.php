...
<head>
    ...
    <title>Residential Letter</title>
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">         
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                      <h5>Residential Letter Format </h5>
                    </li>                
                  </ul>
                  <ul class="navbar-nav ">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class='form-row'>
                                <div class='form-group col-md-9'>
                                    <input type='text' class='form-control form-control-sm' id='residentialL_For' name='residentialL_For' placeholder='Residential Letter For' disabled>
                                    <small id='residentialL_For' class='form-text text-muted'>Residential Letter For</small>                     
                                </div>
                                <div class='form-group col-md-3'>
                                    <input type='number' class='form-control form-control-sm' id='residentialL_Year' name='residentialL_Year' placeholder='Total Year Lived in Maval' disabled>
                        ...
                        <div class="row my-4">
                            <div class="col-12 px-1">
                                <div class="d-flex justify-content-center">
                                    <textarea class="textarea_l" name="letter_to" id="letter_to" cols="30" rows="1"></textarea>                    
                                </div>                 
                            </div>
                        </div>          
                        <br><br><br>
    ...
    <script src="residentialLetter.js"></script> 
