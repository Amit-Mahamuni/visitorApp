...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">         
                  <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                      <h5>Identity Card Letter Format </h5>
                    </li>                
                  </ul>
                  <ul class="navbar-nav ">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class='form-row'>
                                <div class='form-group col-md-4'>
                                    <input type='text' class='form-control form-control-sm' id='total_year_maval' name='total_year_maval' placeholder='Total Man in Family' disabled>
                                        <small id='total_year_maval' class='form-text text-muted'>Total Year Live in Maval</small>                     
                                </div> 
                            </div>                        
                        </div>
                    </div>
    ...
    <script src="identityCardLetter.js"></script> 
