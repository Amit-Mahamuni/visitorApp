...
if(isset($_SESSION['U_Id']) && $_SESSION['Department'] == "Admin" || $_SESSION['Department'] == "Reception" || $_SESSION['Department'] == "Letter")
{
    ...
    <div class="container">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../worklist/workList.php">All Work List</a>
            </li>
    ...
    <div class="row" id="complaint_div">
        <div class="col-md-12 bg-white">
            <div class="table table-reponsive table-bordered my-4 table-hover p-3">
                <table id="government_datatable" class="table table-sm table-reponsive">
                    <thead>
                        <tr>
                            <th width="5%">Id</th>
                            <th width="30%">Work</th>
