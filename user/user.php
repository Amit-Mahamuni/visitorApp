...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../user/user.php">User List </a>
            </li>
    ...
    <div class="container bg-white my-4">
        ...
        <div class="row border border-secondary p-2">
            <div class="col-md-12">
                <table id="User_datatable" class="table table-bordered table-sm table-hover table-reponsive">
                    <thead>
                        <tr>
                            <th width="5%">Id</th>
                            <th width="25%">Name</th>
                        ...
                        <div id="update_div">
                          <div class="row">
                              <div class="col-md-8">
                                  ...
                                  <div class="form-row">
                                      <div class="form-group col-md-6">
                                          <input type="text" class="form-control form-control-sm" id="user_name_up" name="user_name_up" placeholder="User Name" minlength="5" maxlength="10" required>
                                          <small id="user_name_up" class="form-text text-muted">User Name</small>
                                      </div>
                                      <div class="form-group col-md-6">
                                          <input type="text" class="form-control form-control-sm" id="user_password_up" name="user_password_up" placeholder="Password" minlength="5" maxlength="10" required>
                                          <small id="user_password_up" class="form-text text-muted">User Password</small>
                                      </div>
                                  </div>
