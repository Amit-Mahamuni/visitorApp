...
<body>
            ...
            <div class="container border border-dark my-5 p-5">
                ...
                <br>
                    ...
                    <div class="row">
                        <div class="col-12 px-1">
                            <div class="d-flex justify-content-between">
                                <textarea name="jobletter_to" id="jobletter_to" cols="30" rows="5"></textarea>                    
                            </div>                 
                        </div>
                    </div>          
                    ...
                    <div class="row my-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-center">
                                <textarea name="jobletter_subject" id="jobletter_subject" cols="100%" rows="1"></textarea>                    
                            </div> 
                        </div>
                    </div>
                    ...
                    <div class="row my-2">            
                        <div class="col-12">
                            <div class="d-flex justify-content-center">
                                <textarea name="jobletter_detail" id="jobletter_detail" cols="210" rows="10"></textarea>
                            </div>                
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 py-3">
                            <div class="d-flex justify-content-end">
                                <textarea name="jobletter_sign" id="jobletter_sign" cols="30" rows="5"></textarea>                    
                            </div>                 
                        </div>
                    </div>             
            </div>
    ...
    <script src="jobLetterFormat.js"></script>
